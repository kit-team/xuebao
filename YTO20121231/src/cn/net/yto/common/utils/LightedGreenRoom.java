...
public class LightedGreenRoom {
    ...
    /*
     * This is expected to be a singleton. One could potentially make the constructor private I suppose.
     */
    ...
    /*
     * Setting up the green room using a static method. This has to be called before calling any other methods. what it
     * does: 1. Instantiate the object 2. acquire the lock to turn on lights Assumption: It is not required to be
     * synchronized because it will be called from the main thread. (Could be wrong. need to validate this!!)
     */
     ...
     * 
     * This is a synchronized method as multiple threads will be entering and leaving.
     */
    ...
    /*
     * acquire the wake lock to turn the lights on it is upto other synchronized methods to call this at the appropriate
     * time.
     */
    ...
    /*
     * Release the wake lock to turn the lights off. it is upto other synchronized methods to call this at the
     * appropriate time.
     */
