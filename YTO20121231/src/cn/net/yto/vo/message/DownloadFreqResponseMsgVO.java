 ...
 * 
 */
public class DownloadFreqResponseMsgVO extends BaseResponseMsgVO {
	private List<FreqVO> syncRecords;
	private int havaNextPage;
	private String tableName;

	public List<FreqVO> getSyncRecords() {
		return syncRecords;
	}

	public void setSyncRecords(List<FreqVO> syncRecords) {
