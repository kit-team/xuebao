...
/**
 * 
 * @author fubo ProgressDialog 和 Toast的辅助类
 */
public class DialogHelper {
	...
	public static void showAlertDialog(Activity activity, String msg,
		...
		builder.setPositiveButton(R.string.key_f3_ok, positiveListener);
		builder.setNegativeButton(R.string.key_f4_cancel, negativeListener);
