 ...
 * 
 */
public class DownloadOrderChannelResponseMsgVO extends BaseResponseMsgVO {
	private List<OrderChannelVO> syncRecords;
	private int havaNextPage;
	private String tableName;

	public List<OrderChannelVO> getSyncRecords() {
		return syncRecords;
	}

	public void setSyncRecords(List<OrderChannelVO> syncRecords) {
