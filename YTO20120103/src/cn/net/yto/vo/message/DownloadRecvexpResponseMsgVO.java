 ...
 * 
 */
public class DownloadRecvexpResponseMsgVO extends BaseResponseMsgVO {
	private List<RecvexpVO> syncRecords;
	private int havaNextPage;
	private String tableName;

	public List<RecvexpVO> getSyncRecords() {
		return syncRecords;
	}

	public void setSyncRecords(List<RecvexpVO> syncRecords) {
