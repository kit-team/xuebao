...
public class ReceiveViewDetailActivity extends BaseActivity {
	...
	private void initView(){
		setContentView(R.layout.activity_receive_view_detail);
		mCancelBtn = (Button) findViewById(R.id.btn_cancel);
		mExchangeBtn = (Button) findViewById(R.id.btn_exchange);
		mModifyBtn = (Button) findViewById(R.id.btn_modify);
		
		mListView = (ListView) findViewById(android.R.id.list);
		mReceiveViewDetailAdapter = new ReceiveViewDetailAdapter(this, mReceiveViewDetailList);
