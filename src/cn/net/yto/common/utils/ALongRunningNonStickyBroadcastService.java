...
public abstract class ALongRunningNonStickyBroadcastService extends IntentService {
    ...
    /*
     * This method can be invoked under two circumstances 1. When a broadcast receiver issues a "startService" 2. when
     * android restarts it due to pending "startService" intents.
     * 
     * In case 1, the broadcast receiver has already setup the "lightedgreenroom".
     * 
     ...
     * 
     * Override this method from IntentService. Retrieve the original broadcast intent. Call the derived class to handle
     * the broadcast intent. finally tell the ligthed room that you are leaving. if this is the last visitor then the
    ...
    /*
     * If Android reclaims this process, this method will release the lock irrespective of how many visitors there are.
     */
    @Override
