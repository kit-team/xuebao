...
public class ReceiveExpressViewPagerItem extends ViewPageItemAbs {
	...
	protected void save() {
		...
		String salesmanTime = CommonUtils.getFormatedDateTime("yyyy-MM-dd",
				date.getTimeInMillis());
		receiveVo.setSalesmanTime(salesmanTime);
		...
		try {
			...
			Toast.makeText(mContext, R.string.network_error, Toast.LENGTH_LONG)
					.show();
		}
	...
	private void updateOrderState() {
		OrderVO vo = ReceiveExpressPageActivity.getOrderTab().getOrderVO();
		if (vo != null) {
