...
public class SignEmergencyActivity extends Activity {
    ...
    private void initViews() {
        mListView = (ListView) findViewById(R.id.list_sign_ecc);
        // init data
        mAdapter = new SignEmergencyAdapter(this);
    ...
    private View getListHeadView() {
        ...
        head1.setText(R.string.list_head_emergency_waybillno);
        head1.setVisibility(View.VISIBLE);
        TextView head2 = (TextView) headView.findViewById(R.id.head2);
        head2.setText(R.string.list_head_emergency_empcode);
        ...
        secondhead2.setText(R.string.list_head_emergency_time);
     ...
     * "comment                       - emergency time"
     * 
     * @author Administrator
     * 
     */
    private class SignEmergencyAdapter extends SignListBasicAdapter {
