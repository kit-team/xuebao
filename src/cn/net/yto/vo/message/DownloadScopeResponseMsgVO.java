 ...
 * 
 */
public class DownloadScopeResponseMsgVO extends BaseResponseMsgVO {
	private List<ScopeVO> syncRecords;
	private int havaNextPage;
	private String tableName;

	public List<ScopeVO> getSyncRecords() {
		return syncRecords;
	}

	public void setSyncRecords(List<ScopeVO> syncRecords) {
