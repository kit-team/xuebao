 ...
 * 
 */
public class DownloadScanRuleResponseMsgVO extends BaseResponseMsgVO {
	private List<ScanruleVO> syncRecords;
	private int havaNextPage;
	private String tableName;

	public List<ScanruleVO> getSyncRecords() {
		return syncRecords;
	}

	public void setSyncRecords(List<ScanruleVO> syncRecords) {
