 ...
 * 
 */
public class DownloadDictionaryResponseMsgVO extends BaseResponseMsgVO {
	private List<DictionaryVO> syncRecords;
	private int havaNextPage;
	private String tableName;

	public List<DictionaryVO> getSyncRecords() {
		return syncRecords;
	}

	public void setSyncRecords(List<DictionaryVO> syncRecords) {
