 ...
 * 
 */
public class DownloadBlackListResponseMsgVO extends BaseResponseMsgVO {
	private List<BlackListVO> syncRecords;
	private int havaNextPage;
	private String tableName;

	public List<BlackListVO> getSyncRecords() {
		return syncRecords;
	}

	public void setSyncRecords(List<BlackListVO> syncRecords) {
