...
public class UserService {
	...
	public boolean submitSignedLog(SignedLog signedLog, Listener listener) {
		DeliverySignedLogRequestMsgVO requestMsgVO = new DeliverySignedLogRequestMsgVO();
		// TODO map SignedLog to the DeliverySignedLogRequestMsgVO
		ZltdHttpClient client = new ZltdHttpClient(UrlType.SUBMIT_SIGNEDLOG, requestMsgVO,
				listener, DeliverySignedLogResponseMsgVO.class);
